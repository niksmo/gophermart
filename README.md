# Интернет-магазин с накопительной системой лояльности «Гофермарт»
...
Хендлер доступен только аутентифицированным пользователям. Номером заказа является последовательностью цифр произвольной длины.
